...
import { createApp, runReminderScan, runCampaignScan, runAutomationScan, runContactBirthdayScan, SCAN_EVERY_MS } from "./app.js";
...
setInterval(runContactBirthdayScan, SCAN_EVERY_MS).unref();
