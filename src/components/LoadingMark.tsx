...
// the logo (see Logo.tsx's <Mark/>), drawn with a continuous "flowing ink"
// stroke animation instead of sitting static. Monochrome: currentColor
// (theme ink), so it reads white-on-black in dark and black-on-white in
// light with no gradient — matching the greyscale system.
  ...
  return (
    ...
    >
      <path
        ...
        stroke="currentColor" strokeWidth="12.5" strokeLinecap="round" strokeLinejoin="round"
        pathLength={1}
      />
      <path
        className="loading-mark-stroke loading-mark-stroke-2"
        d="M60 46 C64 63 70 77 81 73 C93 69 98 50 101 32"
        stroke="currentColor" strokeWidth="22" strokeLinecap="round" strokeLinejoin="round"
        pathLength={1}
      />
      <circle className="loading-mark-dot" cx="101" cy="30" r="12.5" fill="currentColor" />
    </svg>
  );
}
